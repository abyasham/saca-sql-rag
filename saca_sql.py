...
def biz_bot_ui_app (db="postgres", table_name=None, fp=None,doc=None):
    ...
    with st.sidebar:
        ...
        if uploaded_table:
            ...
            st.write(f"Completed - Table - Rows - {row_count} - is Ready.")
...
if __name__ == "__main__":
    ...
    #   By default, the SACA SQL starts with a loaded document and CSV (which can then be changed directly in the UI)
    ...
    #   IMPORTANT NOTE:  to run this script, follow the streamlit formalism and run from the cli,
